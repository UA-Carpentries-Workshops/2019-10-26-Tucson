...
instructor: ["Noah Nelson", "Sateesh Peri", "Kelsey	Gonzalez", "Xue Pan", "Travis Struck", "Marnee Dearman", "Uwe Hilgert"] # boxed, comma-separated list of instructors' names as strings, like ["Kay McNulty", "Betty Jennings", "Betty Snyder"]
helper: ["Drake	Asberry", "Brian	Bell", "Jennifer	Kadowaki", "David	LeBauer", "Torbet	McNeil", "Cesar Medina", "Upendra Devisetty",  "Adriana	Picoral", "Fernando Rios", "Austin	Rutherford", "Saren	Seeley"]     # boxed, comma-separated list of helpers' names, like ["Marlyn Wescoff", "Fran Bilas", "Ruth Lichterman"]
...
collaborative_notes: https://pad.carpentries.org/2019-10-26-Tucson            # optional: URL for the workshop collaborative notes, e.g. an Etherpad or Google Docs document
